...
pi_arg2ix(Eterm arg)
{
    ...
    case am_message_queue_stats:		return 34;
    default:					return -1;
    }
}
...
BIF_RETTYPE statistics_1(BIF_ALIST_1)
{
    ...
    else if (BIF_ARG_1 == am_message_queues) {
	Uint i;
	Uint nproc = 0;
	Uint msgq_sum = 0;
	Uint msgq_max = 0;
    ...
    else if (BIF_ARG_1 == am_message_counts) {
	Uint i;
	Uint nproc = 0;
